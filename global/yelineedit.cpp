...
LineEditSideWidget::LineEditSideWidget(QWidget *parent)
    : QWidget(parent)
{
}

bool LineEditSideWidget::event(QEvent *event)
{
...
void LineEdit::init()
{
	m_leftWidget = new LineEditSideWidget(this);
	...
	m_rightWidget = new LineEditSideWidget(this);
...
LineEditButton *LineEdit::addButton(WidgetPosition position, const QString &tips, const QObject *receiver, const char *method)
{
	LineEditButton *button = new LineEditButton;
	button->setToolTip(tips);
	addWidget(button, position);
	if (receiver != NULL) {
